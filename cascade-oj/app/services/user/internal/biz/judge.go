...
type JudgeRepo interface {
	...
	GetSelfTest(ctx context.Context, submissionUUID string) (*SelfTest, error)
	GetSubmissions(ctx context.Context, contestID int64, problemID int64) ([]*Submission, error)
	GetSingleSubmission(ctx context.Context, submissionUUID string) (*Submission, error)
	GetCases(ctx context.Context, submissionUUID string) ([]*Case, error)
}
...
func (judgeUsecase *JudgeUsecase) GetSelfTest(ctx context.Context, submissionUUID string) (*SelfTest, error) {
	return judgeUsecase.repo.GetSelfTest(ctx, submissionUUID)
}
...
func (judgeUsecase *JudgeUsecase) GetSingleSubmission(ctx context.Context, submissionUUID string) (*Submission, error) {
	return judgeUsecase.repo.GetSingleSubmission(ctx, submissionUUID)
}

func (judgeUsecase *JudgeUsecase) GetCases(ctx context.Context, submissionUUID string) ([]*Case, error) {
	return judgeUsecase.repo.GetCases(ctx, submissionUUID)
}
