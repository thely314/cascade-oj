...
func (registerUsecase *RegisterUsecase) RegisterGateway(ctx context.Context, register *Register) error {
	return registerUsecase.registerRepo.RegisterGateway(ctx, register)
}
