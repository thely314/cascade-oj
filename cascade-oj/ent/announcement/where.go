...
func PublisherID(v int) predicate.Announcement {
...
func PublisherIDEQ(v int) predicate.Announcement {
	return predicate.Announcement(sql.FieldEQ(FieldPublisherID, v))
}

// PublisherIDNEQ applies the NEQ predicate on the "publisher_id" field.
func PublisherIDNEQ(v int) predicate.Announcement {
...
func PublisherIDIn(vs ...int) predicate.Announcement {
...
func PublisherIDNotIn(vs ...int) predicate.Announcement {
