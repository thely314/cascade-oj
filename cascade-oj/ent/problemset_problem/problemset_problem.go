...
const (
	// Label holds the string label denoting the problemset_problem type in the database.
	...
	EdgeProblem = "problem"
	// Table holds the table name of the problemset_problem in the database.
...
// Columns holds all SQL columns for problemset_problem fields.
var Columns = []string{
	FieldID,
	FieldProblemSetID,
	FieldProblemID,
...
// OrderOption defines the ordering options for the ProblemSet_Problem queries.
