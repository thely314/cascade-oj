...
func (_q *ProblemSetUserQuery) Limit(limit int) *ProblemSetUserQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *ProblemSetUserQuery) Offset(offset int) *ProblemSetUserQuery {
...
func (_q *ProblemSetUserQuery) Unique(unique bool) *ProblemSetUserQuery {
...
func (_q *ProblemSetUserQuery) QueryUser() *UserQuery {
...
func (_q *ProblemSetUserQuery) QueryProblemSet() *ProblemSetQuery {
...
func (_q *ProblemSetUserQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*ProblemSetUserQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *ProblemSetUserQuery) CountX(ctx context.Context) int {
...
func (_q *ProblemSetUserQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *ProblemSetUserQuery) ExistX(ctx context.Context) bool {
...
// Clone returns a duplicate of the ProblemSetUserQuery builder, including all associated steps. It can be
// used to prepare common query builders and use them differently after the clone is made.
func (_q *ProblemSetUserQuery) Clone() *ProblemSetUserQuery {
	if _q == nil {
		return nil
	}
...
func (_q *ProblemSetUserQuery) WithUser(opts ...func(*UserQuery)) *ProblemSetUserQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ProblemSetUserQuery) WithProblemSet(opts ...func(*ProblemSetQuery)) *ProblemSetUserQuery {
	query := (&ProblemSetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// Aggregate returns a ProblemSetUserSelect configured with the given aggregations.
func (_q *ProblemSetUserQuery) Aggregate(fns ...AggregateFunc) *ProblemSetUserSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *ProblemSetUserQuery) prepareQuery(ctx context.Context) error {
...
func (_q *ProblemSetUserQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_g *ProblemSetUserGroupBy) Aggregate(fns ...AggregateFunc) *ProblemSetUserGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *ProblemSetUserGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ProblemSetUserQuery, *ProblemSetUserGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *ProblemSetUserGroupBy) sqlScan(ctx context.Context, root *ProblemSetUserQuery, v any) error {
...
// ProblemSetUserSelect is the builder for selecting fields of ProblemSetUser entities.
type ProblemSetUserSelect struct {
	*ProblemSetUserQuery
	selector
}

// Aggregate adds the given aggregation functions to the selector query.
func (_s *ProblemSetUserSelect) Aggregate(fns ...AggregateFunc) *ProblemSetUserSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *ProblemSetUserSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ProblemSetUserQuery, *ProblemSetUserSelect](ctx, _s.ProblemSetUserQuery, _s, _s.inters, v)
}

func (_s *ProblemSetUserSelect) sqlScan(ctx context.Context, root *ProblemSetUserQuery, v any) error {
