...
func (_q *AnnouncementQuery) QueryPublisher() *UserQuery {
...
func (_q *AnnouncementQuery) WithPublisher(opts ...func(*UserQuery)) *AnnouncementQuery {
	query := (&UserClient{config: _q.config}).Query()
...
//		GroupBy(announcement.FieldPublisherID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Announcement.Query().
//		Select(announcement.FieldPublisherID).
//		Scan(ctx, &v)
...
func (_q *AnnouncementQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Announcement, error) {
	...
	if query := _q.withPublisher; query != nil {
		if err := _q.loadPublisher(ctx, query, nodes, nil,
			func(n *Announcement, e *User) { n.Edges.Publisher = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AnnouncementQuery) loadPublisher(ctx context.Context, query *UserQuery, nodes []*Announcement, init func(*Announcement), assign func(*Announcement, *User)) error {
...
func (_q *AnnouncementQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withPublisher != nil {
			_spec.Node.AddColumnOnce(announcement.FieldPublisherID)
		}
	}
