...
const (
	// Label holds the string label denoting the problemsetmanager type in the database.
	Label = "problem_set_manager"
	...
	// Table holds the table name of the problemsetmanager in the database.
	Table = "ProblemSet_Managers"
	// AdminTable is the table that holds the admin relation/edge.
	AdminTable = "ProblemSet_Managers"
	...
	ProblemSetTable = "ProblemSet_Managers"
...
// Columns holds all SQL columns for problemsetmanager fields.
var Columns = []string{
	FieldID,
	FieldAdminID,
	FieldProblemSetID,
...
// OrderOption defines the ordering options for the ProblemSetManager queries.
