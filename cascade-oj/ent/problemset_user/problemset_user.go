...
const (
	// Label holds the string label denoting the problemset_user type in the database.
	...
	// Table holds the table name of the problemset_user in the database.
...
// Columns holds all SQL columns for problemset_user fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldProblemSetID,
...
// OrderOption defines the ordering options for the ProblemSet_User queries.
