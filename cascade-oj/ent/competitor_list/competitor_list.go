...
const (
	// Label holds the string label denoting the competitor_list type in the database.
	...
	// Table holds the table name of the competitor_list in the database.
	Table = "Competitor_List"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "Competitor_List"
	...
	ProblemSetTable = "Competitor_List"
...
// Columns holds all SQL columns for competitor_list fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldProblemSetID,
...
// OrderOption defines the ordering options for the Competitor_List queries.
