...
func (_d *ProblemSetProblemDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *ProblemSetProblemDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *ProblemSetProblemDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *ProblemSetProblemDeleteOne) ExecX(ctx context.Context) {
