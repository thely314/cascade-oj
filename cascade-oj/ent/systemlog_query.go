...
func (_q *SystemLogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *SystemLogQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *SystemLogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *SystemLogQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *SystemLogQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *SystemLogQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(systemlog.FieldLogTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *SystemLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(systemlog.Table, systemlog.Columns, sqlgraph.NewFieldSpec(systemlog.FieldID, field.TypeInt64))
	_spec.From = _q.sql
