...
func (e AnnouncementEdges) PublisherOrErr() (*User, error) {
	if e.Publisher != nil {
...
func (*Announcement) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case announcement.FieldID, announcement.FieldPublisherID:
...
// QueryPublisher queries the "publisher" edge of the Announcement entity.
func (_m *Announcement) QueryPublisher() *UserQuery {
	return NewAnnouncementClient(_m.config).QueryPublisher(_m)
}
