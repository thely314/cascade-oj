...
const (
	// Label holds the string label denoting the problemset_includes type in the database.
	Label = "problem_set_includes"
	...
	EdgeProblem = "problem"
	// Table holds the table name of the problemset_includes in the database.
	Table = "ProblemSet_Includes"
	// ProblemSetTable is the table that holds the problem_set relation/edge.
	ProblemSetTable = "ProblemSet_Includes"
	...
	ProblemTable = "ProblemSet_Includes"
...
// Columns holds all SQL columns for problemset_includes fields.
var Columns = []string{
	FieldID,
	FieldProblemSetID,
	FieldProblemID,
...
// OrderOption defines the ordering options for the ProblemSet_Includes queries.
