...
const file_admin_v1_admin_proto_rawDesc = "" +
	...
	"\tfilenames\x18\x01 \x03(\tR\tfilenames2\xcf\x1c\n" +
	"\x05Admin\x12x\n" +
	...
	"\n" +
	"DeleteUser\x12'.api.cascade.admin.v1.DeleteUserRequest\x1a%.api.cascade.admin.v1.DeleteUserReply\"\x1e\x82\xd3\xe4\x93\x02\x18*\x16/admin/users/{user_id}\x12\xab\x01\n" +
...
var file_admin_v1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_admin_v1_admin_proto_goTypes = []any{
	...
	(*GetContestStatisticsRequest)(nil),          // 49: api.cascade.admin.v1.GetContestStatisticsRequest
	(*GetContestStatisticsReply)(nil),            // 50: api.cascade.admin.v1.GetContestStatisticsReply
	(*ListLogFilesRequest)(nil),                  // 51: api.cascade.admin.v1.ListLogFilesRequest
	(*ListLogFilesReply)(nil),                    // 52: api.cascade.admin.v1.ListLogFilesReply
	(*QueryLogContentRequest)(nil),               // 53: api.cascade.admin.v1.QueryLogContentRequest
	(*QueryLogContentReply)(nil),                 // 54: api.cascade.admin.v1.QueryLogContentReply
	(*DownloadLogsRequest)(nil),                  // 55: api.cascade.admin.v1.DownloadLogsRequest
	(*PostContestRequest_ProblemList)(nil),       // 56: api.cascade.admin.v1.PostContestRequest.ProblemList
	(*GetSingleSubmissionReply_CaseResults)(nil), // 57: api.cascade.admin.v1.GetSingleSubmissionReply.CaseResults
	(*GetRanksReply_RankItem)(nil),               // 58: api.cascade.admin.v1.GetRanksReply.RankItem
	(*GetAnnouncementsReply_Announcement)(nil),   // 59: api.cascade.admin.v1.GetAnnouncementsReply.Announcement
	(*timestamppb.Timestamp)(nil),                // 60: google.protobuf.Timestamp
	(*httpbody.HttpBody)(nil),                    // 61: google.api.HttpBody
}
var file_admin_v1_admin_proto_depIdxs = []int32{
	60, // 0: api.cascade.admin.v1.ContestMetadata.start_time:type_name -> google.protobuf.Timestamp
	60, // 1: api.cascade.admin.v1.ContestMetadata.end_time:type_name -> google.protobuf.Timestamp
	...
	60, // 4: api.cascade.admin.v1.PostContestRequest.start_time:type_name -> google.protobuf.Timestamp
	60, // 5: api.cascade.admin.v1.PostContestRequest.end_time:type_name -> google.protobuf.Timestamp
	56, // 6: api.cascade.admin.v1.PostContestRequest.problems:type_name -> api.cascade.admin.v1.PostContestRequest.ProblemList
	60, // 7: api.cascade.admin.v1.PutContestRequest.start_time:type_name -> google.protobuf.Timestamp
	60, // 8: api.cascade.admin.v1.PutContestRequest.end_time:type_name -> google.protobuf.Timestamp
	...
	60, // 13: api.cascade.admin.v1.SubmissionMetadata.submit_time:type_name -> google.protobuf.Timestamp
	...
	57, // 16: api.cascade.admin.v1.GetSingleSubmissionReply.case_results:type_name -> api.cascade.admin.v1.GetSingleSubmissionReply.CaseResults
	58, // 17: api.cascade.admin.v1.GetRanksReply.ranks:type_name -> api.cascade.admin.v1.GetRanksReply.RankItem
	59, // 18: api.cascade.admin.v1.GetAnnouncementsReply.announcements:type_name -> api.cascade.admin.v1.GetAnnouncementsReply.Announcement
	42, // 19: api.cascade.admin.v1.GetUsersReply.users:type_name -> api.cascade.admin.v1.UserInfo
	60, // 20: api.cascade.admin.v1.QueryLogContentRequest.time_start:type_name -> google.protobuf.Timestamp
	60, // 21: api.cascade.admin.v1.QueryLogContentRequest.time_end:type_name -> google.protobuf.Timestamp
	27, // 22: api.cascade.admin.v1.GetSingleSubmissionReply.CaseResults.cases:type_name -> api.cascade.admin.v1.CaseMetadata
	1,  // 23: api.cascade.admin.v1.Admin.GetContests:input_type -> api.cascade.admin.v1.GetContestsRequest
	3,  // 24: api.cascade.admin.v1.Admin.GetSingleContest:input_type -> api.cascade.admin.v1.GetSingleContestRequest
	5,  // 25: api.cascade.admin.v1.Admin.PostContest:input_type -> api.cascade.admin.v1.PostContestRequest
	7,  // 26: api.cascade.admin.v1.Admin.PutContest:input_type -> api.cascade.admin.v1.PutContestRequest
	9,  // 27: api.cascade.admin.v1.Admin.DeleteContest:input_type -> api.cascade.admin.v1.DeleteContestRequest
	12, // 28: api.cascade.admin.v1.Admin.GetProblems:input_type -> api.cascade.admin.v1.GetProblemsRequest
	14, // 29: api.cascade.admin.v1.Admin.GetSingleProblem:input_type -> api.cascade.admin.v1.GetSingleProblemRequest
	16, // 30: api.cascade.admin.v1.Admin.PostProblem:input_type -> api.cascade.admin.v1.PostProblemRequest
	18, // 31: api.cascade.admin.v1.Admin.PutProblem:input_type -> api.cascade.admin.v1.PutProblemRequest
	20, // 32: api.cascade.admin.v1.Admin.DeleteProblem:input_type -> api.cascade.admin.v1.DeleteProblemRequest
	22, // 33: api.cascade.admin.v1.Admin.PublishProblem:input_type -> api.cascade.admin.v1.PublishProblemRequest
	25, // 34: api.cascade.admin.v1.Admin.GetSubmissions:input_type -> api.cascade.admin.v1.GetSubmissionsRequest
	28, // 35: api.cascade.admin.v1.Admin.GetSingleSubmission:input_type -> api.cascade.admin.v1.GetSingleSubmissionRequest
	30, // 36: api.cascade.admin.v1.Admin.RejudgeSubmission:input_type -> api.cascade.admin.v1.RejudgeSubmissionRequest
	32, // 37: api.cascade.admin.v1.Admin.GetRanks:input_type -> api.cascade.admin.v1.GetRanksRequest
	34, // 38: api.cascade.admin.v1.Admin.GetAnnouncements:input_type -> api.cascade.admin.v1.GetAnnouncementsRequest
	36, // 39: api.cascade.admin.v1.Admin.PostAnnouncement:input_type -> api.cascade.admin.v1.PostAnnouncementRequest
	38, // 40: api.cascade.admin.v1.Admin.PutAnnouncement:input_type -> api.cascade.admin.v1.PutAnnouncementRequest
	40, // 41: api.cascade.admin.v1.Admin.DeleteAnnouncement:input_type -> api.cascade.admin.v1.DeleteAnnouncementRequest
	43, // 42: api.cascade.admin.v1.Admin.GetUsers:input_type -> api.cascade.admin.v1.GetUsersRequest
	45, // 43: api.cascade.admin.v1.Admin.UpdateUserInfo:input_type -> api.cascade.admin.v1.UpdateUserInfoRequest
	47, // 44: api.cascade.admin.v1.Admin.DeleteUser:input_type -> api.cascade.admin.v1.DeleteUserRequest
	49, // 45: api.cascade.admin.v1.Admin.GetContestStatistics:input_type -> api.cascade.admin.v1.GetContestStatisticsRequest
	51, // 46: api.cascade.admin.v1.Admin.ListLogFiles:input_type -> api.cascade.admin.v1.ListLogFilesRequest
	53, // 47: api.cascade.admin.v1.Admin.QueryLogContent:input_type -> api.cascade.admin.v1.QueryLogContentRequest
	55, // 48: api.cascade.admin.v1.Admin.DownloadLogs:input_type -> api.cascade.admin.v1.DownloadLogsRequest
	2,  // 49: api.cascade.admin.v1.Admin.GetContests:output_type -> api.cascade.admin.v1.GetContestsReply
	4,  // 50: api.cascade.admin.v1.Admin.GetSingleContest:output_type -> api.cascade.admin.v1.GetSingleContestReply
	6,  // 51: api.cascade.admin.v1.Admin.PostContest:output_type -> api.cascade.admin.v1.PostContestReply
	8,  // 52: api.cascade.admin.v1.Admin.PutContest:output_type -> api.cascade.admin.v1.PutContestReply
	10, // 53: api.cascade.admin.v1.Admin.DeleteContest:output_type -> api.cascade.admin.v1.DeleteContestReply
	13, // 54: api.cascade.admin.v1.Admin.GetProblems:output_type -> api.cascade.admin.v1.GetProblemsReply
	15, // 55: api.cascade.admin.v1.Admin.GetSingleProblem:output_type -> api.cascade.admin.v1.GetSingleProblemReply
	17, // 56: api.cascade.admin.v1.Admin.PostProblem:output_type -> api.cascade.admin.v1.PostProblemReply
	19, // 57: api.cascade.admin.v1.Admin.PutProblem:output_type -> api.cascade.admin.v1.PutProblemReply
	21, // 58: api.cascade.admin.v1.Admin.DeleteProblem:output_type -> api.cascade.admin.v1.DeleteProblemReply
	23, // 59: api.cascade.admin.v1.Admin.PublishProblem:output_type -> api.cascade.admin.v1.PublishProblemReply
	26, // 60: api.cascade.admin.v1.Admin.GetSubmissions:output_type -> api.cascade.admin.v1.GetSubmissionsReply
	29, // 61: api.cascade.admin.v1.Admin.GetSingleSubmission:output_type -> api.cascade.admin.v1.GetSingleSubmissionReply
	31, // 62: api.cascade.admin.v1.Admin.RejudgeSubmission:output_type -> api.cascade.admin.v1.RejudgeSubmissionReply
	33, // 63: api.cascade.admin.v1.Admin.GetRanks:output_type -> api.cascade.admin.v1.GetRanksReply
	35, // 64: api.cascade.admin.v1.Admin.GetAnnouncements:output_type -> api.cascade.admin.v1.GetAnnouncementsReply
	37, // 65: api.cascade.admin.v1.Admin.PostAnnouncement:output_type -> api.cascade.admin.v1.PostAnnouncementReply
	39, // 66: api.cascade.admin.v1.Admin.PutAnnouncement:output_type -> api.cascade.admin.v1.PutAnnouncementReply
	41, // 67: api.cascade.admin.v1.Admin.DeleteAnnouncement:output_type -> api.cascade.admin.v1.DeleteAnnouncementReply
	44, // 68: api.cascade.admin.v1.Admin.GetUsers:output_type -> api.cascade.admin.v1.GetUsersReply
	46, // 69: api.cascade.admin.v1.Admin.UpdateUserInfo:output_type -> api.cascade.admin.v1.UpdateUserInfoReply
	48, // 70: api.cascade.admin.v1.Admin.DeleteUser:output_type -> api.cascade.admin.v1.DeleteUserReply
	50, // 71: api.cascade.admin.v1.Admin.GetContestStatistics:output_type -> api.cascade.admin.v1.GetContestStatisticsReply
	52, // 72: api.cascade.admin.v1.Admin.ListLogFiles:output_type -> api.cascade.admin.v1.ListLogFilesReply
	54, // 73: api.cascade.admin.v1.Admin.QueryLogContent:output_type -> api.cascade.admin.v1.QueryLogContentReply
	61, // 74: api.cascade.admin.v1.Admin.DownloadLogs:output_type -> google.api.HttpBody
