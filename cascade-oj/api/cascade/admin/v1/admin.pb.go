...
type GetLogsReply struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Logs          []*GetLogsReply_LogEntry `protobuf:"bytes,1,rep,name=logs,proto3" json:"logs,omitempty"` // List of log entries
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetLogsReply) GetLogs() []*GetLogsReply_LogEntry {
	if x != nil {
		return x.Logs
	}
	return nil
...
type GetLogsReply_LogEntry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`              // Log ID
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`     // Log Message
	Timestamp     *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Log Timestamp
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetLogsReply_LogEntry) Reset() {
	*x = GetLogsReply_LogEntry{}
	mi := &file_admin_v1_admin_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetLogsReply_LogEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLogsReply_LogEntry) ProtoMessage() {}

func (x *GetLogsReply_LogEntry) ProtoReflect() protoreflect.Message {
	mi := &file_admin_v1_admin_proto_msgTypes[65]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLogsReply_LogEntry.ProtoReflect.Descriptor instead.
func (*GetLogsReply_LogEntry) Descriptor() ([]byte, []int) {
	return file_admin_v1_admin_proto_rawDescGZIP(), []int{60, 0}
}

func (x *GetLogsReply_LogEntry) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetLogsReply_LogEntry) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GetLogsReply_LogEntry) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
const file_admin_v1_admin_proto_rawDesc = "" +
	"\n" +
	"\x14admin/v1/admin.proto\x12\x14api.cascade.admin.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x13errors/errors.proto\"\xc1\x01\n" +
	...
	"\x0fstatistics_json\x18\x01 \x01(\tR\x0estatisticsJson\"A\n" +
	"\x0eGetLogsRequest\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x05R\x04page\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\"\xbf\x01\n" +
	"\fGetLogsReply\x12?\n" +
	"\x04logs\x18\x01 \x03(\v2+.api.cascade.admin.v1.GetLogsReply.LogEntryR\x04logs\x1an\n" +
	"\bLogEntry\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x128\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp2\xc8\x1f\n" +
	"\x05Admin\x12x\n" +
	...
	"\x14GetContestStatistics\x121.api.cascade.admin.v1.GetContestStatisticsRequest\x1a/.api.cascade.admin.v1.GetContestStatisticsReply\"/\x82\xd3\xe4\x93\x02)\x12'/admin/contests/{contest_id}/statistics\x12h\n" +
	"\aGetLogs\x12$.api.cascade.admin.v1.GetLogsRequest\x1a\".api.cascade.admin.v1.GetLogsReply\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/admin/logsB\xbd\x01\n" +
...
var file_admin_v1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_admin_v1_admin_proto_goTypes = []any{
	...
	(*GetLogsRequest)(nil),                       // 59: api.cascade.admin.v1.GetLogsRequest
	(*GetLogsReply)(nil),                         // 60: api.cascade.admin.v1.GetLogsReply
	(*PostContestRequest_ProblemList)(nil),       // 61: api.cascade.admin.v1.PostContestRequest.ProblemList
	(*GetSingleSubmissionReply_CaseResults)(nil), // 62: api.cascade.admin.v1.GetSingleSubmissionReply.CaseResults
	(*GetRanksReply_RankItem)(nil),               // 63: api.cascade.admin.v1.GetRanksReply.RankItem
	(*GetAnnouncementsReply_Announcement)(nil),   // 64: api.cascade.admin.v1.GetAnnouncementsReply.Announcement
	(*GetLogsReply_LogEntry)(nil),                // 65: api.cascade.admin.v1.GetLogsReply.LogEntry
	(*timestamppb.Timestamp)(nil),                // 66: google.protobuf.Timestamp
}
var file_admin_v1_admin_proto_depIdxs = []int32{
	66, // 0: api.cascade.admin.v1.ContestMetadata.start_time:type_name -> google.protobuf.Timestamp
	66, // 1: api.cascade.admin.v1.ContestMetadata.end_time:type_name -> google.protobuf.Timestamp
	...
	66, // 4: api.cascade.admin.v1.PostContestRequest.start_time:type_name -> google.protobuf.Timestamp
	66, // 5: api.cascade.admin.v1.PostContestRequest.end_time:type_name -> google.protobuf.Timestamp
	61, // 6: api.cascade.admin.v1.PostContestRequest.problems:type_name -> api.cascade.admin.v1.PostContestRequest.ProblemList
	66, // 7: api.cascade.admin.v1.PutContestRequest.start_time:type_name -> google.protobuf.Timestamp
	66, // 8: api.cascade.admin.v1.PutContestRequest.end_time:type_name -> google.protobuf.Timestamp
	...
	66, // 13: api.cascade.admin.v1.SubmissionMetadata.submit_time:type_name -> google.protobuf.Timestamp
	...
	62, // 16: api.cascade.admin.v1.GetSingleSubmissionReply.case_results:type_name -> api.cascade.admin.v1.GetSingleSubmissionReply.CaseResults
	63, // 17: api.cascade.admin.v1.GetRanksReply.ranks:type_name -> api.cascade.admin.v1.GetRanksReply.RankItem
	64, // 18: api.cascade.admin.v1.GetAnnouncementsReply.announcements:type_name -> api.cascade.admin.v1.GetAnnouncementsReply.Announcement
	...
	65, // 21: api.cascade.admin.v1.GetLogsReply.logs:type_name -> api.cascade.admin.v1.GetLogsReply.LogEntry
	27, // 22: api.cascade.admin.v1.GetSingleSubmissionReply.CaseResults.cases:type_name -> api.cascade.admin.v1.CaseMetadata
	66, // 23: api.cascade.admin.v1.GetLogsReply.LogEntry.timestamp:type_name -> google.protobuf.Timestamp
	...
	59, // 51: api.cascade.admin.v1.Admin.GetLogs:input_type -> api.cascade.admin.v1.GetLogsRequest
	2,  // 52: api.cascade.admin.v1.Admin.GetContests:output_type -> api.cascade.admin.v1.GetContestsReply
	4,  // 53: api.cascade.admin.v1.Admin.GetSingleContest:output_type -> api.cascade.admin.v1.GetSingleContestReply
	6,  // 54: api.cascade.admin.v1.Admin.PostContest:output_type -> api.cascade.admin.v1.PostContestReply
	8,  // 55: api.cascade.admin.v1.Admin.PutContest:output_type -> api.cascade.admin.v1.PutContestReply
	10, // 56: api.cascade.admin.v1.Admin.DeleteContest:output_type -> api.cascade.admin.v1.DeleteContestReply
	13, // 57: api.cascade.admin.v1.Admin.GetProblems:output_type -> api.cascade.admin.v1.GetProblemsReply
	15, // 58: api.cascade.admin.v1.Admin.GetSingleProblem:output_type -> api.cascade.admin.v1.GetSingleProblemReply
	17, // 59: api.cascade.admin.v1.Admin.PostProblem:output_type -> api.cascade.admin.v1.PostProblemReply
	19, // 60: api.cascade.admin.v1.Admin.PutProblem:output_type -> api.cascade.admin.v1.PutProblemReply
	21, // 61: api.cascade.admin.v1.Admin.DeleteProblem:output_type -> api.cascade.admin.v1.DeleteProblemReply
	23, // 62: api.cascade.admin.v1.Admin.PublishProblem:output_type -> api.cascade.admin.v1.PublishProblemReply
	26, // 63: api.cascade.admin.v1.Admin.GetSubmissions:output_type -> api.cascade.admin.v1.GetSubmissionsReply
	29, // 64: api.cascade.admin.v1.Admin.GetSingleSubmission:output_type -> api.cascade.admin.v1.GetSingleSubmissionReply
	31, // 65: api.cascade.admin.v1.Admin.RejudgeSubmission:output_type -> api.cascade.admin.v1.RejudgeSubmissionReply
	33, // 66: api.cascade.admin.v1.Admin.GetRanks:output_type -> api.cascade.admin.v1.GetRanksReply
	35, // 67: api.cascade.admin.v1.Admin.GetAnnouncements:output_type -> api.cascade.admin.v1.GetAnnouncementsReply
	37, // 68: api.cascade.admin.v1.Admin.PostAnnouncement:output_type -> api.cascade.admin.v1.PostAnnouncementReply
	39, // 69: api.cascade.admin.v1.Admin.PutAnnouncement:output_type -> api.cascade.admin.v1.PutAnnouncementReply
	41, // 70: api.cascade.admin.v1.Admin.DeleteAnnouncement:output_type -> api.cascade.admin.v1.DeleteAnnouncementReply
	44, // 71: api.cascade.admin.v1.Admin.GetUsers:output_type -> api.cascade.admin.v1.GetUsersReply
	46, // 72: api.cascade.admin.v1.Admin.UpdateUserInfo:output_type -> api.cascade.admin.v1.UpdateUserInfoReply
	48, // 73: api.cascade.admin.v1.Admin.DeleteUser:output_type -> api.cascade.admin.v1.DeleteUserReply
	50, // 74: api.cascade.admin.v1.Admin.GetContestUsers:output_type -> api.cascade.admin.v1.GetContestUsersReply
	52, // 75: api.cascade.admin.v1.Admin.AddContestUser:output_type -> api.cascade.admin.v1.AddContestUserReply
	54, // 76: api.cascade.admin.v1.Admin.RemoveContestUser:output_type -> api.cascade.admin.v1.RemoveContestUserReply
	56, // 77: api.cascade.admin.v1.Admin.UpdateUserPassword:output_type -> api.cascade.admin.v1.UpdateUserPasswordReply
	58, // 78: api.cascade.admin.v1.Admin.GetContestStatistics:output_type -> api.cascade.admin.v1.GetContestStatisticsReply
	60, // 79: api.cascade.admin.v1.Admin.GetLogs:output_type -> api.cascade.admin.v1.GetLogsReply
