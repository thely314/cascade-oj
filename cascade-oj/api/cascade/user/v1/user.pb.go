...
type GetSingleSubmissionReply struct {
	...
	Code          string                 `protobuf:"bytes,2,opt,name=code,proto3" json:"code,omitempty"`                               // User Code
	Language      string                 `protobuf:"bytes,3,opt,name=language,proto3" json:"language,omitempty"`                       // Programming Language
	TimeCost      string                 `protobuf:"bytes,4,opt,name=time_cost,json=timeCost,proto3" json:"time_cost,omitempty"`       // Time Cost
	MemoryCost    string                 `protobuf:"bytes,5,opt,name=memory_cost,json=memoryCost,proto3" json:"memory_cost,omitempty"` // Memory Cost
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSingleSubmissionReply) GetTimeCost() string {
	if x != nil {
		return x.TimeCost
	}
	return ""
...
func (x *GetSingleSubmissionReply) GetMemoryCost() string {
	if x != nil {
		return x.MemoryCost
	}
	return ""
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1a\n" +
	"\blanguage\x18\x03 \x01(\tR\blanguage\x12\x1b\n" +
	"\ttime_cost\x18\x04 \x01(\tR\btimeCost\x12\x1f\n" +
	"\vmemory_cost\x18\x05 \x01(\tR\n" +
	"memoryCost\"0\n" +
